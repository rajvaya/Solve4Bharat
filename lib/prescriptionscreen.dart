...
import 'package:solve4bharat_vaani/Email.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text("Name : " + PatientObject['data']['name'].toString(),
                  style: apnastyle),
              Text(
                "Gender : " + PatientObject['data']['gender'].toString(),
                style: apnastyle,
              ),
              Text(
                "Date of Birth : " + PatientObject['data']['dob'].toString(),
                style: apnastyle,
              ),
              Text(
                "Email : " + PatientObject['data']['email'].toString(),
                style: apnastyle,
              ),
              Text(
                "Phone : " + PatientObject['data']['phone'].toString(),
                style: apnastyle,
              ),
              Padding(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text("Send Email to Patient"),
      ),
    );
  }
}
